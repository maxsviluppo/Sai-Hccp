...
@Component({
    ...
    <div class="space-y-6 animate-fade-in h-full flex flex-col">
        <!-- Header -->
        <div>
            <h2 class="text-2xl font-bold text-slate-800">Conservazione Alimenti (Temperature)</h2>
            <p class="text-slate-500 text-sm">Monitoraggio temperature e stoccaggio</p>
        </div>
