    ...
    <div class="space-y-8 pb-10">
        ...
        <div class="bg-gradient-to-r from-blue-600 via-sky-600 to-cyan-600 p-8 rounded-3xl shadow-xl border border-blue-500/30 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <p class="text-sky-100 text-sm mt-2 font-medium ml-1">
                    Monitoraggio temperature e stoccaggio
                </p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            @for (check of checks(); track check.id) {
                <div class="bg-white p-6 rounded-2xl shadow-sm border-2 transition-all duration-300 group"
                     ...
                     [class.border-blue-200]="!check.checked"
                     [class.border-blue-500]="check.checked"
                     [class.bg-blue-50]="check.checked"
                     [class.shadow-lg]="check.checked"
                     [class.shadow-blue-200/50]="check.checked"
                    ...
                    <div class="flex items-start gap-4">
                        <div class="flex-shrink-0 w-14 h-14 rounded-2xl flex items-center justify-center transition-all duration-300"
                             [class.bg-blue-500]="check.checked"
                             [class.text-white]="check.checked"
                             [class.shadow-lg]="check.checked"
                             [class.shadow-blue-200]="check.checked"
                            ...
                            <i class="fa-solid text-2xl"
                               ...
                               [class.fa-temperature-low]="!check.checked"></i>
                        </div>
