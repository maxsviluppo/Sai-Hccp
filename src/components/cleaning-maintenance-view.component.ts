...
@Component({
    ...
    <div class="space-y-6 animate-fade-in h-full flex flex-col">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                <h2 class="text-2xl font-bold text-slate-800">Pulizia / Disinfezione / Manutenzione</h2>
                <p class="text-slate-500 text-sm">Registro attività di pulizia e manutenzione</p>
            </div>
             <!-- Context Indicator -->
